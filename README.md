...
## Project Overview
This project uses statistical methods such as **co-occurrence counting, TF-IDF, and Pointwise Mutual Information (PMI)** to explore various **distributional semantics techniques** for analyzing word representations. The evaluations are performed on well-known similarity datasets, including **MEN and SimLex-999**, to assess how well different word vector representations capture semantic relationships.
...
- **Example Co-occurrence Counts:**
  - **"Chicken" and "the"** → **52** (w=3), **103** (w=6)
  - **"Coffee" and "the"** → **95** (w=3), **201** (w=6)
...
- Evaluated performance using **Spearman correlation** on similarity datasets:
